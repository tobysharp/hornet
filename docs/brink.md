...
# Semantic English View of Specification
...
# Executable Declarative C++ View of Specification
...
static constexpr auto kHeaderRules = All{
  ...
  Rule{ValidateProofOfWork},            // A header's hash MUST NOT exceed o its own proof-of-work target.
