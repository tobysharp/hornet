...
/* [[BIP::HeightInCoinbase]] */ [[nodiscard]] inline ValidateBlockResult ValidateCoinbaseHeight(
...
/* [[BIP::SegWit]] */ [[nodiscard]] inline ValidateBlockResult ValidateWitnessCommitment(
    const BlockValidationContext& context) {
